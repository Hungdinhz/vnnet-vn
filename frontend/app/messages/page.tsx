              ...
              conversations.map((conv, idx) => {
                ...
                return (
                  <button 
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-3 hover:bg-black/5 dark:hover:bg-black/5 dark:bg-white/5 transition-colors text-left ${isSelected ? 'bg-purple-500/10 border-l-[3px] border-purple-500' : 'border-l-[3px] border-transparent'}`}
                  >
                    <div className="relative flex-shrink-0">
                      {contact.avatarUrl ? (
                        ...
                        <div className="w-12 h-12 bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-full flex items-center justify-center font-bold text-secondary border border-purple-500/20 text-lg">
              ...
              <div className="px-6 py-3 border-b border-purple-500/10 flex items-center gap-3 bg-black/20">
                <div className="relative flex-shrink-0">
                  {selectedContact.avatarUrl ? (
                    ...
                    <div className="w-10 h-10 bg-gradient-to-br from-purple-500/30 to-pink-500/30 rounded-full flex items-center justify-center font-bold text-secondary border border-purple-500/20">
                      ...
                      <div key={msg.id || idx} className={`flex ${isMine ? 'justify-end' : 'justify-start'}`}>
                        <div className={`max-w-[70%] rounded-2xl px-4 py-2 text-[14px] leading-relaxed shadow-sm ${
                          isMine 
                            ...
                            : 'bg-black/10 dark:bg-white/10 text-foreground rounded-tl-sm border border-purple-500/10'
                        }`}>
                          <p>{msg.content}</p>
...
export default function MessagesPage() {
  return (
    <Suspense fallback={<div className="min-h-screen bg-background flex items-center justify-center"><div className="animate-spin rounded-full h-8 w-8 border-b-2 border-purple-500"></div></div>}>
      <MessagesContent />
    </Suspense>
  );
}
